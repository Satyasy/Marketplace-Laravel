...
@section('content')
    <div class="container mx-auto px-4 py-8">
        <h1 class="text-3xl font-bold text-primary mb-6">Kategori: {{ ucfirst($category) }}</h1>
        ...
        <div class="grid grid-cols-2 md:grid-cols-4 gap-4">
            ...
            <div class="bg-white rounded-lg shadow-md overflow-hidden hover:shadow-lg transition">
                ...
                <div class="p-4">
                    <h3 class="font-semibold text-dark mb-1">{{ ucfirst($category) }} {{ $i }}</h3>
                    <p class="text-gray-600 text-sm mb-2">{{ ucfirst($category) }}</p>
